...
{
	Route::get('/marketplace', [MarketController::class, 'show'])->name('marketplace');
	Route::get('/marketplace/categories/{category}', [MarketController::class, 'categories'])->name('marketplace.categories');

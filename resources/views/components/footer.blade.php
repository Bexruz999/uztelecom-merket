				...
				<div class="footer__top-item footer__top-social">
					<ul class="social-list">
						<li class="social-list__item">
							<a href="#">
								<img src="{{ asset('images/marketplace/instagram.svg') }}" alt="#">
							</a>
						</li>
						<li class="social-list__item">
							<a href="#">
								<img src="{{ asset('images/marketplace/vkontakte.svg') }}" alt="#">
							</a>
						</li>
						<li class="social-list__item">
							<a href="#">
								<img src="{{ asset('images/marketplace/facebook.svg') }}" alt="#">
							</a>
						</li>
						<li class="social-list__item">
							<a href="#">
								<img src="{{ asset('images/marketplace/youtube.svg') }}" alt="#">
							</a>
						</li>
					</ul>
				</div>
